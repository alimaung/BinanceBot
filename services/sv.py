...
MACHINES = {
    "bull": {"ip": "192.168.1.42", "mac": "6C:24:08:8A:AF:B2", "user": "bullb"},
    "bear": {"ip": "192.168.1.69", "mac": "6C:24:08:8A:AF:B0", "user": "bearb"},
}
...
def ping(ip_address):
    ...
    try:
        ...
        process = subprocess.Popen(["ping", "-n", "1", ip_address], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
